...
|---|---|---|---|
| Adopt the curated SA dataset (NLCD + NLUD + tree-canopy compound LULC + matched biophysical tables) | Received 2026-05-23 | 🔄 LULC raster + crosswalk adopted 2026-05-24 (Brief 27, foundational); UCM (Brief 28b) and UNA (Brief 29) biophysical tables now compound-keyed; Carbon table queued for Brief 30 | Data folder in `data/sa/natcap_2024/`. README: "please update all input data to what is contained here." Multi-brief workstream tracked in `SA_INTEGRATION_PLAN.md`. |
