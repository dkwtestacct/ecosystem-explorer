...
`SCENARIO_SCHEMA_VERSION = 26` invalidates cached lookup tables across changes to the metric schema. Per-city caches don't collide because the cache key includes the data directory and filename arguments to `load_data`.
