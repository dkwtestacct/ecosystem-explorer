...
**`validation/` (7):** `compare_carbon_invest.py`, `compare_carbon_sa_fourpool_invest.py`, `compare_ufr_invest.py`, `compare_ucm_invest.py`, `compare_umh_invest.py`, `compare_una_invest.py`, `verify_cooling.py` — canonical-InVEST parity comparators.
