...
st.markdown(
    "Higher is generally better for benefit metrics (including Flood Index and "
    "Runoff Retention); lower is better for Runoff Volume and Implementation Cost."
)
st.caption(
...
eco1.metric(
    ...
    help=(
        ...
        "Unitless indicator derived from Curve Number (100 − mean CN). Higher "
        "generally indicates lower runoff potential. Useful for "
...
eco3.metric(
    ...
    help=(
        "Lower is better. "
        "Confidence: High — see 'How this prototype works' for tier definitions. "
        "Modeled runoff volume for the design storm. Lower values indicate less runoff. "
...
eco3b.metric(
    ...
    help=(
        ...
        "definitions. Share of design-storm rainfall retained, averaged per pixel "
        "(mean(1 − Q/P)). Higher means more rainfall absorbed rather than running "
        "off — the per-pixel companion to Flood Index. "
        "Computed as the canonical InVEST UFR runoff-retention index "
...
st.caption(
    "Flood metrics: higher Flood Index and higher Runoff Retention are better; "
