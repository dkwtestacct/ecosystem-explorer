...
_carbon_delta_str = (
    f"+{_carbon_value:,.0f} tons CO2e/yr vs base" if _carbon_value >= 1.0
...
eco4.metric(
    ...
    help=(
        ...
        "Uses provisional regional USDA/IPCC rates: Food Forest 3.5 tons CO2e/acre/yr, "
        "Green Infrastructure 2.0 tons CO2e/acre/yr. "
