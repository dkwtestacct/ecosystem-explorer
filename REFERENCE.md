...
| Nature Access | `max(urban_nature × in_range)` per pixel, threshold at 0.3 | Urban Nature Access (2SFCA supply/demand/balance) | Proxy | Medium |
| Nature Quality Score | Pop-weighted mean of 0–1 access score | Urban Nature Access (SUP_DEMadm_cap) | Proxy | Medium |
