...
| **Road exclusion coverage** | Road exclusion uses the full OpenStreetMap road network (Geofabrik Minnesota extract, filtered to 42,064 segments), covering approximately 62 % of the model AOI. This includes all paved and semi-paved surfaces — motorways, residential streets, service alleys, footways, cycleways, and stairs. Approximately 38 % of AOI pixels remain eligible for conversion after excluding buildings and roads. Prior versions used a manually curated subset covering ~11 % of AOI. |
